...
var DynaAnimation_1 = __webpack_require__(2);
...
var DynaAnimation = /** @class */ (function (_super) {
    ...
    DynaAnimation.prototype.render = function () {
        ...
        var className = [
            'dyna-animation',
            userClassName || '',
            Object.keys(animations).map(function (animationName) { return "animation-" + animationName + "-" + (animations[animationName] ? 'on' : 'off'); }).join(' '),
        ].join(' ').trim();
