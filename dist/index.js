...
var DynaAnimation3dFlip = /** @class */ (function (_super) {
    ...
    DynaAnimation3dFlip.prototype.getContainerStyle = function () {
        var _a = this.props, perspective = _a.perspective, width = _a.width, height = _a.height;
        var outputStyle = {
    ...
    DynaAnimation3dFlip.prototype.render = function () {
        var _a = this.props, userClassName = _a.className, animationEnabled = _a.animationEnabled, show = _a.show, direction = _a.direction, duration = _a.duration, children = _a.children;
        var className = [
            userClassName,
        ...
        return (React.createElement(DynaAnimation_1.DynaAnimation, { className: className, animations: animations, style: this.getContainerStyle() },
            React.createElement("div", { className: "dyna-animation-3d-flip__child", style: this.getChildStyle() }, children)));
    };
...
var DynaAnimationVerticalContainer = /** @class */ (function (_super) {
    ...
    DynaAnimationVerticalContainer.prototype.refresh = function () {
        ...
        setTimeout(function () { return _this.show(_this.props.show); }, 300);
    };
